...
const BraintreeAcceleratedCheckoutForm: FunctionComponent<BraintreeAcceleratedCheckoutFormProps> = ({
    renderPayPalConnectComponent,
}) => {
    const { instruments, isAddingNewInstrument, selectedInstrument, handleUseNewInstrument, handleSelectInstrument } =
