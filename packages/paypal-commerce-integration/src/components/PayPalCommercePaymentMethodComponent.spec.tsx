...
describe('PayPalCommercePaymentMethodComponent', () => {
    ...
    it('initializes PayPalCommerce with required props', () => {
        ...
        const component = mount(<PayPalCommercePaymentMethodComponent {...props} />);

        expect(component.find(PayPalCommercePaymentMethodComponent)).toHaveLength(1);
    ...
    it('initializes PayPalCommerce with extended initialization options', () => {
        ...
        const component = mount(<PayPalCommercePaymentMethodComponent {...newProps} />);
    ...
    it('deinitializes PayPalCommerce with required props', () => {
        ...
        expect(component.find(PayPalCommercePaymentMethodComponent)).toHaveLength(0);
    ...
    it('catches error during PayPalCommerce initialization', async () => {
        ...
        mount(<PayPalCommercePaymentMethodComponent {...props} />);
    ...
    it('renders provided child component', async () => {
        ...
        expect(document.getElementById(testId)).toBeDefined();
    });
    ...
    it('hides payment submit button by calling onRenderButton callback', async () => {
        ...
        mount(<PayPalCommercePaymentMethodComponent {...newProps} />);
